...
export default function Header() {
  ...
  return (
    ...
    >
      {/* Top bar */}
      <div className={`py-2 px-2 md:px-4 text-center text-sm ${theme === 'dark' ? 'bg-gray-700 text-gray-300' : 'bg-gray-50 text-gray-600'}`}>
      ...
      {/* Navigation */}
      <nav className={`px-2 md:px-4 py-2 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-b`}>
        <div className="max-w-7xl mx-auto">
          <ul className="hidden md:flex items-center gap-6 text-sm font-medium">
            <li><Link to="/" className={`hover:text-indigo-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Home</Link></li>
            <li><a href="#products" className={`hover:text-indigo-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Products</a></li>
            <li><a href="#" className={`hover:text-indigo-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Categories</a></li>
            <li><a href="#" className={`hover:text-indigo-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Deals</a></li>
            <li><a href="#" className={`hover:text-indigo-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>About</a></li>
            <li><a href="#" className={`hover:text-indigo-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Contact</a></li>
          </ul>
        </div>
      </nav>
    </header>
